...
declare namespace ServerCommonAuth {
    ...
    interface ListShopUsefulAgentCommand {
        current?: number;
        pageSize?: number;
        sort?: CommonCommonEnum.Sort;
        direction?: BasicTypes.Direction;
    ...
    interface ListShopUsefulAgentCommandQuery {
        current?: number;
        pageSize?: number;
        sort?: CommonCommonEnum.Sort;
        direction?: BasicTypes.Direction;
    ...
    interface ListShopUsefulAgentResult {
        list: ListShopUsefulAgentRow[] | null;
        total: number;
        query: ListShopUsefulAgentCommand;
    }

    interface ListShopUsefulAgentRow {
        userID: string;
        mobile: string;
        nickname: string;
        imgUrl: string;
    ...
    interface UpdateCustomerCommandPathParams {
        userID: string;
    }

    interface UpdateCustomerCommandWithoutPath {
        isStar: boolean | null;
