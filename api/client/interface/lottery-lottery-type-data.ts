...
export function getCharityLotteryData(query: LotteryDataSource.ListCharityLotteryCommandQuery) {
    return request<BasicTypes.DefaultResponseWrapper<LotteryDataSource.CharityLotteryDataSource[] | null>>({ method: 'GET', url: '/api/v1/lottery/lottery-type/data/charity', query })
}
