...
export function createShopApi(data: ServerCommonShop.CreateShopCommand) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonShop.CreateShopResult>>({ method: 'POST', url: '/api/v1/lottery/shop', data })
}
...
export function getByShopCodeApi(pathParams: ServerCommonShop.ShopCodePathParams) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonShop.LotteryShop>>({ method: 'GET', url: `/api/v1/lottery/shop/shopCode/${pathParams.shopCode}/getShopMessage` })
}


// 获取彩票商店列表
export function listShopApi(query: ServerCommonShop.ListShopCommandQuery) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonShop.PageData>>({ method: 'GET', url: '/api/v1/lottery/shop', query })
}
