...
export function createSignOut(data: ServerCommonAuth.UserSignOutCommandWithoutPath, pathParams: ServerCommonAuth.UserSignOutCommandPathParams, header: ServerCommonAuth.UserSignOutCommandHeaderWithoutPath) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.UserSignOutResult>>({ method: 'POST', url: `/api/v1/users/auth/${pathParams.userID}/sign-out`, data, header })
}


// 解析推荐信息
export function decodeReferralUrl(query: ServerCommonAuth.DecodeReferralUrlCommandQuery) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.DecodeReferralUrlCommandResult>>({ method: 'GET', url: '/api/v1/users/auth/decode-referral-info', ignoreAuth: true, query })
}


// 获取验证码
export function generatorCaptcha() {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.GenerateCaptchaResult>>({ method: 'GET', url: '/api/v1/users/auth/captcha' })
}
...
export function getDefaultAvatar() {
    return request<BasicTypes.DefaultResponseWrapper<string>>({ method: 'GET', url: '/api/v1/users/auth/avatar' })
}
...
export function getToken(pathParams: ServerCommonAuth.GetUserTokenCommandPathParams, header: ServerCommonAuth.GetUserTokenCommandHeaderWithoutPath) {
    return request<BasicTypes.DefaultResponseWrapper<string>>({ method: 'GET', url: `/api/v1/users/auth/${pathParams.userID}/refresh-token`, ignoreAuth: true, header })
}
...
export function getUserBasicInfoApi(pathParams: ServerCommonAuth.GetUserBasicInfoCommandPathParams, header: ServerCommonAuth.GetUserBasicInfoCommandHeaderWithoutPath) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonUser.User>>({ method: 'GET', url: `/api/v1/users/auth/${pathParams.userID}/basic-info`, header })
}
...
export function getUserInfo(pathParams: ServerCommonAuth.GetUserInfoCommandPathParams, header: ServerCommonAuth.GetUserInfoCommandHeaderWithoutPath) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.GetUserInfoResult>>({ method: 'GET', url: `/api/v1/users/auth/user-info/${pathParams.userID}`, header })
}
...
export function listReferralInfo(query: ServerCommonAuth.ListReferralInfoCommandQuery, header: ServerCommonAuth.ListReferralInfoCommandHeader) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.ListReferralInfoResult>>({ method: 'GET', url: '/api/v1/users/auth/list-referral-info', query, header })
}


// 获取用户列表
export function listUser(query: ServerCommonAuth.ListUserCommandQuery, header: ServerCommonAuth.ListUserCommandHeader) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.PageData>>({ method: 'GET', url: '/api/v1/users/auth/list/user', query, header })
}
...
export function listUserByCursor(query: ServerCommonAuth.ListUserByCursorCommandQuery, header: ServerCommonAuth.ListUserByCursorCommandHeader) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.PageData>>({ method: 'GET', url: '/api/v1/users/auth/list/user/cursor', query, header })
}
...
export function refreshToken(pathParams: ServerCommonAuth.RefreshTokenCommandPathParams, header: ServerCommonAuth.RefreshTokenCommandHeaderWithoutPath) {
    return request<BasicTypes.DefaultResponseWrapper<string>>({ method: 'GET', url: `/api/v1/users/auth/${pathParams.userID}/refresh/token`, header })
}
...
export function userLogoutApi(pathParams: ServerCommonAuth.LogoutCommandPathParams, header: ServerCommonAuth.LogoutCommandHeaderWithoutPath) {
    return request<BasicTypes.DefaultResponseWrapper<any>>({ method: 'DELETE', url: `/api/v1/users/auth/${pathParams.userID}/logout`, header })
}
...
export function userResetPasswordApi(data: ServerCommonAuth.UserResetPasswordCommand, header: ServerCommonAuth.UserResetPasswordCommandHeader) {
    return request<BasicTypes.DefaultResponseWrapper<any>>({ method: 'PUT', url: '/api/v1/users/auth/reset/password', data, header })
}


// 用户登入接口
export function userSignInApi(data: ServerCommonAuth.UserSignInCommand) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.UserSignInResult>>({ method: 'POST', url: '/api/v1/users/auth/sign-in', ignoreAuth: true, data })
}
...
export function userUpdateBasicInfoApi(data: ServerCommonAuth.UpdateBasicInfoCommandWithoutPath, pathParams: ServerCommonAuth.UpdateBasicInfoCommandPathParams, header: ServerCommonAuth.UpdateBasicInfoCommandHeaderWithoutPath) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.UpdateBasicInfoResult>>({ method: 'PATCH', url: `/api/v1/users/auth/${pathParams.userID}/basic-info`, data, header })
}
...
export function userUploadAvatarApi(data: ServerCommonAuth.UserUploadAvatarCommandWithoutPath, pathParams: ServerCommonAuth.UserUploadAvatarCommandPathParams) {
    return request<BasicTypes.DefaultResponseWrapper<ServerCommonAuth.UserUploadAvatarResult>>({ method: 'POST', url: `/api/v1/users/auth/${pathParams.userID}/avatar`, data })
}
